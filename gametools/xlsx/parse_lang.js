...
function readDir(moduleName,export_dir) {
	...
	file_util.writeFile(export_dir+ moduleName+'_font.txt', exports);
	file_util.writeFile(export_dir+ moduleName+'_lang_zh.json', JSON.stringify(coder.pack(langObj,0)));
}
